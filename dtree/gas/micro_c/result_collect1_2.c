...
int main(void) {
    ...
    for (;;) {
        ...
        remote_me_reg_write_signal_remote(interm_result_write, 36, 8, 0, __xfer_reg_number(result_xfer46, __nfp_meid(36, 8)) + (__ctx() * 32), sizeof(result_xfer46), &local_signal);    
    }
