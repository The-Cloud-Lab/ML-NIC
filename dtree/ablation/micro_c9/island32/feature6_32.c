...
int main(void) {
    ...
    for (;;) {
        ...
        if (!(feature > 50 && feature > 54 && feature <= 455 && feature <= 339 && feature <= 282 && feature > 60 && feature > 75 && feature > 238 && feature > 245 && feature <= 261 && feature <= 260 && feature > 253))
            result_gpr[2] &= ~(1 << 28);
        ...
        if (!(feature > 50 && feature > 54 && feature <= 455 && feature <= 339 && feature > 282 && feature > 291 && feature <= 337 && feature <= 330 && feature > 307 && feature > 311 && feature > 313 && feature <= 316))
            result_gpr[1] &= ~(1 << 8);
        ...
        if (!(feature > 50 && feature > 54 && feature > 455 && feature > 493 && feature > 657 && feature <= 764 && feature <= 677))
            result_gpr[1] &= ~(1 << 28);

        if (!(feature > 50 && feature > 54 && feature > 455 && feature > 493 && feature > 657 && feature <= 764 && feature > 677 && feature <= 687))
            result_gpr[1] &= ~(1 << 29);

        if (!(feature > 50 && feature > 54 && feature > 455 && feature > 493 && feature > 657 && feature <= 764 && feature > 677 && feature > 687 && feature <= 695))
            result_gpr[1] &= ~(1 << 30);

        if (!(feature > 50 && feature > 54 && feature > 455 && feature > 493 && feature > 657 && feature <= 764 && feature > 677 && feature > 687 && feature > 695 && feature <= 707))
            result_gpr[1] &= ~(1 << 31);
        ...
        remote_me_reg_write_signal_remote(&result_write, 32, 8, 0, 
                                          __xfer_reg_number(&result_xfer6, __nfp_meid(32, 8)) + (__ctx() * 32), 
