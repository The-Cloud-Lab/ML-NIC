...
__remote __xread uint32_t result_xfer6[5];
...
int main(void) {
    ...
    for (;;) {
        ...
        if (!(feature > 50 && feature > 54 && feature <= 455 && feature > 339 && feature > 430 && feature > 432 && feature > 435 && feature <= 452 && feature > 443 && feature <= 445))
            result_gpr[1] &= ~(1 << 29);
