...
__visible __xread uint32_t result_xfer5[3];
...
int main(void) {
    ...
    __gpr uint32_t results_gpr5[3];
    __gpr uint32_t results_gpr6[3];
    __gpr uint32_t results_gpr7[3];
    __xwrite uint32_t final_result_write;
    
    __lmem uint8_t path_class[] = {3, 1, 0, 0, 2, 2, 2, 2, 1, 6, 0, 6, 6, 0, 0, 0, 0, 6, 0, 6, 0, 0, 2, 0, 3, 6, 6, 6, 6, 0, 0, 0, 6, 0, 0, 3, 2, 3, 3, 2, 0, 2, 0, 0, 0, 0, 0, 6, 0, 0, 0, 6, 0, 3, 5, 5, 0, 2, 0, 6, 6, 3, 0, 0, 0, 0, 0, 6, 6, 0, 0, 0, 0, 0, 6, 0, 0, 4, 5, 4, 0, 0, 6, 0, 0, 0, 0, 6, 4, 0, 0, 0, 6, 0, 0, 0};  
