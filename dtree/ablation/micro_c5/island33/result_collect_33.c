...
int main(void) {
    ...
    __lmem uint8_t path_class[] = {3, 1, 0, 0, 2, 2, 2, 2, 1, 6, 6, 0, 0, 0, 0, 6, 0, 6, 0, 0, 2, 0, 3, 6, 6, 6, 6, 0, 0, 0, 6, 0, 2, 3, 2, 0, 2, 0, 0, 0, 0, 0, 6, 0, 0, 0, 6, 0, 3, 5, 5, 0, 2, 6, 3, 0, 0, 0, 0, 6, 6, 0, 0, 0, 0, 0, 6, 0, 0, 4, 5, 4, 0, 0, 6, 0, 0, 0, 6, 4, 0, 0, 0, 0, 6, 0, 0, 6, 0, 6, 6, 0, 6, 6, 6, 0, 0, 0, 3, 3, 3, 0, 0, 0, 0, 0, 4, 0, 6, 0, 3, 3, 3, 3, 3, 0, 0, 6, 0, 0, 0, 0, };
    ...
    for (;;) {
        ...
        if (results_gpr7[0] != 0)
            results_gpr7[0] = ffs(results_gpr7[0]) + 96;
        else if (results_gpr7[1] != 0)
            results_gpr7[0] = ffs(results_gpr7[1]) + 64;
        else if (results_gpr7[2] != 0)
            results_gpr7[0] = ffs(results_gpr7[2]) + 32;
        else
            results_gpr7[0] = ffs(results_gpr7[3]);        
