...
int main(void) {
    ...
    for(;;) {
        ...
        reg_cp(&feature, &remote_xfer20, sizeof(feature));
        feature &= 0xffff;
        ...
        remote_me_reg_write_signal_remote(result_write, 35, 5, 0, __xfer_reg_number(result_xfer20, __nfp_meid(35, 5)) + (__ctx() * 32), sizeof(result_xfer20), &local_signal);
    }
