...
int main(void) {
    ...
    for (;;) {
        ...
        remote_me_reg_write_signal_remote(interm_result_write, 36, 0, 0, __xfer_reg_number(result_xfer45, __nfp_meid(36, 0)) + (__ctx() * 32), sizeof(result_xfer45), &local_signal);    
    }
