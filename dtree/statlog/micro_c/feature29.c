...
int main(void) {
    ...
    for(;;) {
        ...
        reg_cp(&feature, &remote_xfer29, sizeof(feature));
        feature >>= 16;
        ...
        remote_me_reg_write_signal_remote(result_write, 35, 8, 0, __xfer_reg_number(result_xfer29, __nfp_meid(35, 8)) + (__ctx() * 32), sizeof(result_xfer29), &local_signal);
    }
