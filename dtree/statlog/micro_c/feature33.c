...
int main(void) {
    ...
    for(;;) {
        ...
        reg_cp(&feature, &remote_xfer33, sizeof(feature));
        feature >>= 16;
        ...
        remote_me_reg_write_signal_remote(result_write, 35, 9, 0, __xfer_reg_number(result_xfer33, __nfp_meid(35, 9)) + (__ctx() * 32), sizeof(result_xfer33), &local_signal);
    }
