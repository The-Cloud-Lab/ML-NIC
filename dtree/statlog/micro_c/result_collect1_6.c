...
int main(void) {
    ...
    for (;;) {
        ...
        remote_me_reg_write_signal_remote(interm_result_write, 35, 11, 0, __xfer_reg_number(result_xfer42, __nfp_meid(35, 11)) + (__ctx() * 32), sizeof(result_xfer42), &local_signal);    
    }
