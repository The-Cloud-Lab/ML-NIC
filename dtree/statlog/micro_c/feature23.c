...
int main(void) {
    ...
    for(;;) {
        ...
        reg_cp(&feature, &remote_xfer23, sizeof(feature));
        feature >>= 16;
        ...
        remote_me_reg_write_signal_remote(result_write, 35, 6, 0, __xfer_reg_number(result_xfer23, __nfp_meid(35, 6)) + (__ctx() * 32), sizeof(result_xfer23), &local_signal);
    }
