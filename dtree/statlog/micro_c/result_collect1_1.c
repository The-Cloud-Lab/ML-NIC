...
int main(void) {
    ...
    for (;;) {
        ...
        remote_me_reg_write_signal_remote(interm_result_write, 35, 10, 0, __xfer_reg_number(result_xfer37, __nfp_meid(35, 10)) + (__ctx() * 32), sizeof(result_xfer37), &local_signal);    
    }
