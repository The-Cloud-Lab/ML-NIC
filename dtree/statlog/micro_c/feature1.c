...
int main(void) {
    ...
    for(;;) {
        ...
        remote_me_reg_write_signal_remote(result_write, 35, 1, 0, __xfer_reg_number(result_xfer1, __nfp_meid(35, 1)) + (__ctx() * 32), sizeof(result_xfer1), &local_signal);
    }
