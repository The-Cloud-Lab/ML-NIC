...
int main(int argc, char **argv) {
	...
	char *pcap_file = "/home/admin1/netronome_tests/land_mine/nicTest.pcap";
	...
	pred_file = fopen("/home/admin1/netronome_tests/land_mine/p4_pred.txt", "w");
	if (pred_file == NULL) {
	...
	latency_file = fopen("/home/admin1/netronome_tests/land_mine/p4_lat.txt", "w");
