...
int main(int argc, char **argv) {
	...
	char *pcap_file = "/home/admin1/netronome_tests/gas/cpuTest.pcap";
	...
	pred_file = fopen("/home/admin1/netronome_tests/gas/cpu_pred.txt", "w");
	if (pred_file == NULL) {
	...
	latency_file = fopen("/home/admin1/netronome_tests/gas/cpu_lat.txt", "w");
	...
	if (pcap_loop(pcap_handle, 2782, eff_handler, (u_char *)network_handle) != 0) {
