...
int main(int argc, char **argv) {
	...
	char *pcap_file = "/home/admin1/netronome_tests/gas/nicTest.pcap";
	...
	pred_file = fopen("/home/admin1/netronome_tests/gas/mC_pred.txt", "w");
	if (pred_file == NULL) {
	...
	latency_file = fopen("/home/admin1/netronome_tests/gas/mC_lat.txt", "w");
