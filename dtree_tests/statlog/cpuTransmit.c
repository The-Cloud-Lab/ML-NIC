...
int main(int argc, char **argv) {
	...
	char *pcap_file = "/home/admin1/netronome_tests/statlog/cpuTest.pcap";
	char error[PCAP_ERRBUF_SIZE];
	pcap_t *pcap_handle, *network_handle;
	
	// Variables for packet filtering
	struct bpf_program filter;
	char filter_exp[] = "ether src 00:15:4d:13:79:ac && ether dst 08:c0:eb:a6:de:3d && ether proto 0x0800";
	...
	pred_file = fopen("/home/admin1/netronome_tests/statlog/cpu_pred.txt", "w");
	if (pred_file == NULL) {
	...
	latency_file = fopen("/home/admin1/netronome_tests/statlog/cpu_lat.txt", "w");
	...
	if (pcap_loop(pcap_handle, 2000, eff_handler, (u_char *)network_handle) != 0) {
