...
int main(int argc, char **argv) {
	...
	char *pcap_file = "/home/admin1/netronome_tests/statlog/nicTest.pcap";
	...
	pred_file = fopen("/home/admin1/netronome_tests/statlog/mC_pred.txt", "w");
	if (pred_file == NULL) {
	...
	latency_file = fopen("/home/admin1/netronome_tests/statlog/mC_lat.txt", "w");
